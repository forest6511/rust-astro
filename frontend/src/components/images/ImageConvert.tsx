...
export default function ImageConverter() {
  ...
  const getFileTypeColor = (type: string): string => {
    if (type.includes("jpeg") || type.includes("jpg")) return "bg-red-100 text-red-800";
      ...
      <CardContent className="space-y-6">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            {isDragActive ? (
              <p className="text-primary font-medium">ファイルをドロップしてアップロード</p>
            ) : (
              <>
        ...
        {files.length > 0 && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-medium">アップロードしたファイル ({files.length})</h3>
      ...
      {convertedFiles.length > 0 && (
        <CardFooter className="flex flex-col">
          ...
          <div className="w-full space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-medium">変換されたファイル ({convertedFiles.length})</h3>
            </div>
            <div className="max-h-60 overflow-y-auto border rounded-lg divide-y">
